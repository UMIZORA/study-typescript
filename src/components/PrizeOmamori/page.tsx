...
import styles from "@/components/PrizeOmamori/prizeomamori.module.css"
...
const PrizeOmamori: NextPage = () => {
 ...
 type nodeType = {
  ...
  const postDate = data.filter((info) => {
    return info.node.queryACF.itemCate === "item_omamori";
  }) 
