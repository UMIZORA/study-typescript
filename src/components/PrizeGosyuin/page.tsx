...
import styles from "@/components/PrizeGosyuin/prizegosyuin.module.css"
...
const PrizeGosyuin: NextPage = () => {
 ...
 type nodeType = {
  ...
  const postDate = data.filter((info) => {
    return info.node.queryACF.itemCate === "item_gosyuin";
  }) 
